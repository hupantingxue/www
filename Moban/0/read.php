...
<html xmlns="http://www.w3.org/1999/xhtml">
		<title>{流量侠_当前标题}_{流量侠_网站栏目标题}_{流量侠_网站随机标题}</title>
...
======`-.____`-.___\_____/___.-`____.-'======
  ...
  ... 原创模板 盗模板者 佛祖诅咒 你没好报 ...
	...
	<body>
	<div id="Tb">
		<h2><a href="{流量侠_网站域名}" title="{流量侠_网站标题}" target="_blank">{流量侠_网站标题}</a></h2>
	</div>
	<div id="lm">
		<fieldset>
			<ul>
	...
	<div id="Xw">
		...
		<div id="Xw_w">更新时间：{流量侠_发布时间}&nbsp;浏览人气：{流量侠_浏览次数}</div>
				<p>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{流量侠_文章内容}{流量侠_文章内容}<strong>{流量侠_当前标题}</strong>{流量侠_文章内容}{流量侠_文章内容}
				</p>
				<p><br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{流量侠_文章内容}{流量侠_站内轮链}{流量侠_文章内容}{流量侠_当前标题}{流量侠_文章内容}{流量侠_文章内容}
				</p>
				<center>{流量侠_网站图片}</center>
				<p>
	...
	<div id="Db">
		BY {流量侠_网站域名} <strong><a href="{流量侠_网站域名}" target="_blank">{流量侠_网站随机标题}</a></strong> <strong><a href="{流量侠_当前网址}" target="_blank">{流量侠_当前标题}</a></strong> 版权所有 <a href="{流量侠_网站域名}sitemap.html" target="_blank">网站地图</a>
	</div>
	<!-- Baidu Button BEGIN -->
